  ...
  <body>    
    <header class="hidden-xs">
      <div class="container">
          ...
          <div class="col-md-6 ">
            <nav>
              <ul class="list-inline">
                ...
                <li><a href="createapartment.php">Создать предложение</a></li>
        ...
        <div class="row">
          <div class="col-md-12">
            <?php echo ('<div class="col-md-4 col-md-offset-8">Вы вошли как '.$_SESSION['logged_user']->family.' '.$_SESSION['logged_user']->name.'</div>');  ?>
          </div>
        </div>
      </div>  
    </header>
  ...
  <header class="visible-xs">
    ...
    <nav><a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
        ...
        <ul class="dropdown-menu">
            <li><a href="index.php">Главная</a></li>
            <li><a href="list.php">Предложения</a></li>
            <li><a href="addapartment.php">Создать предложение</a></li>
            <li><a href="#contacts">Контакты</a></li>
